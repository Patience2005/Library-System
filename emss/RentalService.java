...
public class RentalService {
    ...
    public RentalTransaction createRental(Customer customer, EquipmentItem selectedItem,
                                          int rentalHours, int conditionLevel) {

        // Evaluate safety using the SafetyChecker
        SafetyResult result = safetyChecker.evaluateSafety(customer.getSkillLevel(), conditionLevel);
